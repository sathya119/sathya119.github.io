...
We can define the line element as $$ds^2=g_{\mu\nu}dx^\mu dx^\nu$$and hence the proper length and proper time are
...
$$x=sin\theta cos\phi,\;y=cos\theta sin\phi,\;z=cos\theta$$
...
$$t=cosh\rho,\;x=sinh\rho cos\phi,\;y=sinh\rho sin\phi$$

$$ds^2=d\rho^2+sinh^2\rho d\phi^2$$